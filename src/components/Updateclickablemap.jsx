...
const ClickableMap = ({product , setProduct}) => {
    ...
    useEffect(() => {
        if (locations.from && locations.to) {
            ...
            setProduct((prevProduct) => ({ ...prevProduct, ...locations }));
        }
    }, [locations]); 
        ...
        if (!map || !isChoosing) {
            ...
            const handleMapClick = async (event) => {
                ...
                if (!fromMarker && isChoosing) {
                    ...
                    setLocations((prev) => ({ ...prev, from: { lat: coords[1], lon: coords[0] } }));
                    ...
                    setLocations((prev) => ({ ...prev, to: { lat: coords[1], lon: coords[0] } }));
    ...
    }, [map, fromMarker, toMarker, isChoosing]);
